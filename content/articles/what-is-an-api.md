...
8th graders touch on this idea when working with structured data. AP CSA students see it formally when calling built-in Java library methods — every method call is really just "ordering off a menu" someone else wrote.

## The one-sentence version

An API is the agreed-upon list of things you're allowed to ask a program to do, and what it promises to hand back.
