...
const THREE_RS = [
  ...
  { c: "bg-ink-2 text-white", t: "Responsibility", d: "Own your learning: complete work honestly, care for shared devices, and communicate when you need help." },
  { c: "bg-string text-heading", t: "Readiness", d: "Arrive on time, prepared to focus, and ready to problem-solve — coding rewards patience and persistence." },
];

function Row({ title, children }: { title?: string; children: React.ReactNode }) {
  return (
    <div className="flex gap-4 items-start py-4 first:pt-0 last:pb-0">
      <span className="mt-2 w-1.5 h-1.5 rounded-full bg-string shrink-0" aria-hidden />
      <div>
        {title && <h4 className="text-heading font-semibold mb-0.5">{title}</h4>}
  ...
  return (
    <>
      ...
      <section id="teacher" className="py-16">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-[1fr_320px] gap-8 items-center mb-10">
            <Reveal>
          ...
          <Reveal className="max-w-xl bg-surface p-7 shadow-[0_4px_24px_-8px_rgba(22,35,61,0.10)]">
          ...
          <div className="grid md:grid-cols-3 gap-5">
            {CURRICULUM.map((c, i) => (
              <Reveal key={c.title} delay={i * 0.06}>
                <div className="h-full bg-surface p-6 shadow-[0_4px_24px_-8px_rgba(22,35,61,0.10)]">
            ...
            <Reveal delay={0.3}>
              <div className="h-full bg-ink p-6 shadow-[0_4px_24px_-8px_rgba(22,35,61,0.10)]">
                <span className="text-xs font-semibold uppercase tracking-wide text-string inline-block mb-3.5">
                  new this year
                </span>
      ...
      <section id="homework" className="py-16 bg-paper-2">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <Reveal className="max-w-2xl bg-surface p-7 shadow-[0_4px_24px_-8px_rgba(22,35,61,0.10)]">
          ...
          <div className="grid md:grid-cols-3 gap-5">
            {THREE_RS.map((r, i) => (
              <Reveal key={r.t} delay={i * 0.08}>
                <div className="text-center bg-surface p-9 shadow-[0_4px_24px_-8px_rgba(22,35,61,0.10)]">
                  <div className={`w-[70px] h-[70px] rounded-full flex items-center justify-center mx-auto mb-5 font-serif text-3xl font-bold ${r.c}`}>
                    R
                  </div>
                  <h3 className="text-lg font-semibold text-heading mb-2">{r.t}</h3>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-5">
            {[
              ...
              { tag: "check daily", title: "Google Classroom", desc: "The primary place for assignments and feedback. Class codes are shared the first week of school." },
            ].map((c, i) => (
      ...
      <section id="attendance" className="py-16 bg-paper-2">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-5">
            <Reveal>
              <div className="h-full bg-surface p-7 shadow-[0_4px_24px_-8px_rgba(22,35,61,0.10)]">
                <h3 className="font-semibold text-heading mb-2">Tardiness</h3>
            ...
            <Reveal delay={0.08}>
              <div className="h-full bg-surface p-7 shadow-[0_4px_24px_-8px_rgba(22,35,61,0.10)]">
                <h3 className="font-semibold text-heading mb-2">Absences</h3>
                <p className="text-sm text-text-soft">
      ...
      <section id="support" className="py-16 bg-ink text-white">
        <div className="max-w-6xl mx-auto px-6">
          <Reveal className="mb-10">
            <span className="font-mono text-xs text-string">{"// extra-help"}</span>
